...
enum Args {
    Serve {
        ...
        /// If true, Penview will exclusively print out the `address:port` of the listening server once it starts.
        ...
        /// Specify a browser binary to use when opening (e.g., "firefox", "chromium").
